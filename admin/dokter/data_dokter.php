                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dokter">
                                    ...
                                    <tbody>
                                            ...
                                            include '../../config.php';
                                            $no = 1;
                                            $sql_poli = mysqli_query ($koneksi, "SELECT * FROM dokter") or die (mysqli_error($koneksi));
                                                while ($data = mysqli_fetch_array($sql_poli)) { ?>
                                                    <tr>
                                                        <td align="center">
                                                            <input type="checkbox" name="checked[]" class="check" value="<?php echo $data['id_dokter']; ?>"/>
                                                        </td>
                                                        <td><?=$no++?>.</td>
                                                        ...
                                                        <td><?=$data['no_telp']?></td>
                                                        <td align="center"> 
                                                            <a href="edit_dokter.php?id=<?php echo $data['id_dokter']; ?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i> Edit</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <form method="post" action="proses_dokter.php">
        ...
        <input name="spesialis" id="spesialis" class="form-control" required />
        <br />
        <label>Alamat</label>
        <textarea name="alamat" id="alamat" class="form-control" required></textarea>
        <br />
        <label>Telp.</label>
        <input name="no_telp" id="no_telp" class="form-control" required />
    	</br>
        <input type="submit" name="tambah_dokter" value="Simpan" class="btn btn-success" />
