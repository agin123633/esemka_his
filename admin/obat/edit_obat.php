					...
					<div id="page-inner">
                        <div class="box">
                          ...
                          <!-- Form Elements -->
                            ...
                            <div class="panel-heading">Ubah Data Obat </div>
                                ...
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        $sql_obat = mysqli_query($koneksi,"SELECT * FROM obat WHERE id_obat='$id'") or die ;(mysqli_error($koneksi));
                                    ...
                                    <form method="post" action="proses_obat.php">
                                        ...
                                        <input name="nama_obat" id="nama_obat" value="<?php echo $data['nama_obat']; ?>" class="form-control" required autofocus/>
                                        <br />
                                        <label>Harga Obat</label>
                                        <input name="harga_obat" id="harga_obat" value="<?php echo $data['harga_obat']; ?>" class="form-control" required />
                                        <br />
                                        <label>Keterangan</label>
                                        <textarea name="ket_obat" id="ket_obat" class="form-control" required><?php echo $data['ket_obat']; ?></textarea>
                                        </br>
